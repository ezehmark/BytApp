...
const mtnPlans = [
  { name: "500MB = ₦150", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },

  { name: "1GB = ₦275", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },

  { name: "2GB = ₦550", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },

  { name: "3GB = ₦825", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },

  { name: "1GB = ₦1,375", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },

  { name: "10GB = ₦2750", uri: "https://i.postimg.cc/JhRWnm0V/mtnIcon.png" },
];

const MtnPlans: React.FC<mtnProps> = ({
  isList,
  toggleCardList,
  onSelectCard,
}) => {
