...
const Message: React.FC<msgProps> = ({isMsg, toggleMsg}) => {
	...
	<TouchableOpacity onPress={toggleMsg} style={styles.menuCircle}>                                                     <Image style={styles.menuIcon} source={{ uri: 'https://i.postimg.cc/ZnGwS6pJ/Picsart-24-11-01-05-41-03-753.png' }} />
                </TouchableOpacity>
