...
const ebayCards = [
  {
    name: "Canada eBay Gift Card  (100 and above)",
    uri: "https://i.postimg.cc/D0ygqNYH/ebay-icon-logo-EA65-D4-EEE0-seeklogo-com.png",
  },

  {
    name: "USA  eBay Gift Card  (100 and above)",
    uri: "https://i.postimg.cc/D0ygqNYH/ebay-icon-logo-EA65-D4-EEE0-seeklogo-com.png",
  },

  {
    name: "USA  eBay Gift Card  (25 to 49)",
    uri: "https://i.postimg.cc/D0ygqNYH/ebay-icon-logo-EA65-D4-EEE0-seeklogo-com.png",
  },

  {
    name: "USA  eBay Gift Card  (50 to 99)",
    uri: "https://i.postimg.cc/D0ygqNYH/ebay-icon-logo-EA65-D4-EEE0-seeklogo-com.png",
  },
];

const EbayCards: React.FC<ebayProps> = ({
  isList,
  toggleCardList,
  onSelectCard,
}) => {
