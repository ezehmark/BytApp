...
const Home: React.FC = () => {
	...
	<View style={styles.services}>
	    ...
	    <Text style={styles.Buy}>Buy</Text>                 <Text style={style.SGiftCards}>Cheap Data</Text>
		<View style={styles.buyIcon}>
		...
		<View style={styles.sellIcon}>
		    <Image style={styles.image} source={{ uri: 'https://i.postimg.cc/nVSBg75hc/shopping-cart-no-bg.png' }} />
		</View>
	    </View>
...
const styles = StyleSheet.create({
    ...
    SGiftCards: {                                              fontWeight: 'bold',                                   fontSize: 20,                                         color: '#ea1c4d',                                     position: 'absolute',                                 bottom: 20,                                           marginLeft: 30,                                     },
    buyData: {
        height: 120,
        width: 160,
        marginVertical: 20,
